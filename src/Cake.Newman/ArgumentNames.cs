namespace Cake.Newman
{
    internal static class ArgumentNames
    {
        ...
        internal const string RequestTimeout = "--timeout-request";
        internal const string ScriptTimeout = "--timeout-script";
        internal const string Insecure = "--insecure";
        internal const string IgnoreRedirects = "--ignore-redirects";
